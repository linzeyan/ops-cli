...
func TestMd5(t *testing.T) {
	testCases := []struct {
		...
		{common.RepoName, "532aeb6eb18c6bfb8750f46a60d28a13"},
...
func TestSha1(t *testing.T) {
	testCases := []struct {
		...
		{common.RepoName, "cc32cdd66c03e92415c44cc701191afcb82bd08d"},
...
func TestSha256(t *testing.T) {
	testCases := []struct {
		...
		{common.RepoName, "e95c20437deefde8b32499f10bccc4d8f813664de63d43ae24db9e4036584d8c"},
...
func TestHashBinary(t *testing.T) {
	...
	args := [][]string{
		...
		{subCommand, cmd.HashMd5, binaryCommand},
		{subCommand, cmd.HashSha1, binaryCommand},
		{subCommand, cmd.HashSha256, binaryCommand},
		{subCommand, cmd.HashSha512, binaryCommand},
	}
	for i := range args {
